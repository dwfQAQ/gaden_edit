...
% The combinational part, which is dependent on the surface area and volume of each molecule
...
% The residual part of the activity coefficient describes the intermolecular forces and is calculated from. 
...
ln_Gama_CH3 = Q_CH3 * (1 - log(theta_OH * Chi_n_m(2,1) + theta_H2O1 * Chi_n_m(3,1)) -...
    (theta_OH * Chi_n_m(1,2)/(theta_CH3 *Chi_n_m(1,2) + theta_CH2 *Chi_n_m(1,2) + theta_H2O1 *Chi_n_m(3,2)) +...
    theta_H2O1 * Chi_n_m(1,3)/(theta_CH3 *Chi_n_m(1,3) + theta_CH2 *Chi_n_m(1,3) + theta_OH *Chi_n_m(2,3))));
...
ln_Gama_OH = Q_OH * (1 - log(theta_CH3 * Chi_n_m(1,2) + theta_CH2 * Chi_n_m(1,2) + theta_H2O1 * Chi_n_m(3,2)) -...
    (theta_CH3 * Chi_n_m(2,1)/(theta_OH *Chi_n_m(2,1) + theta_H2O1 *Chi_n_m(3,1)) +...
    theta_CH2 * Chi_n_m(2,1)/(theta_OH *Chi_n_m(2,1) + theta_H2O1 *Chi_n_m(3,1)) +...
    theta_H2O1 * Chi_n_m(2,3)/(theta_CH3 *Chi_n_m(1,3) + theta_CH2 *Chi_n_m(1,3) + theta_OH *Chi_n_m(2,3))));

ln_Gama_H2O = Q_H2O * (1 - log(theta_CH3 * Chi_n_m(1,3) + theta_CH2 * Chi_n_m(1,3) + theta_OH * Chi_n_m(2,3)) -...
    (theta_CH3 * Chi_n_m(3,1)/(theta_OH *Chi_n_m(2,1) + theta_H2O1 *Chi_n_m(3,1)) +...
    theta_CH2 * Chi_n_m(3,1)/(theta_OH *Chi_n_m(2,1) + theta_H2O1 *Chi_n_m(3,1)) +...
    theta_OH * Chi_n_m(3,2)/(theta_CH3 *Chi_n_m(1,2) + theta_CH2 *Chi_n_m(1,2) + theta_H2O1 *Chi_n_m(3,2))));

% Gamma_i_k
ln_Gama_C2H6O_CH3 = Q_CH3 * (1 - log(theta_OH * Chi_n_m(2,1)) -...
    (theta_OH * Chi_n_m(1,2)/(theta_CH3 *Chi_n_m(1,2) + theta_CH2 *Chi_n_m(1,2))));
...
ln_Gama_C2H6O_OH = Q_OH * (1 - log(theta_CH3 * Chi_n_m(1,2) + theta_CH2 * Chi_n_m(1,2)) -...
    (theta_CH3 * Chi_n_m(2,1)/theta_OH *Chi_n_m(2,1) +...
    theta_CH2 * Chi_n_m(2,1)/theta_OH *Chi_n_m(2,1)));
...
gamma_C2H6O = exp(ln_gamma_C2H6O);
